...
### 📊 专业绘图模式 (NEW!)
- **模式切换** - 在模拟模式和绘图模式之间无缝切换
- **标准符号库** - 12种专业光学元件符号（激光器、反射镜、透镜、AOM、分束器等）
- **智能标注** - 支持上下标语法（如 `AOM_1`、`λ^2`）、自动定位
- **布局工具** - 网格吸附、角度吸附、对齐、均匀分布、元件分组
- **高质量导出** - SVG/PNG/PDF三种格式，支持300DPI高分辨率
- **预设模板** - 期刊论文、演示文稿、海报、学位论文等模板
- **批量导出** - 多场景批量导出，自定义命名模式
