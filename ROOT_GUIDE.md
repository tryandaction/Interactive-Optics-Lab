...
- **项目目录视图**：支持目录层级显示与文件夹操作（新建/重命名/删除），并支持拖拽移动场景到目录。
...
- `DESKTOP_GUIDE.md`：桌面版打包指南  
- `COMMERCIAL_PLAN.md`：商业落地与产品化规划
- `TEST_PLAN_DESKTOP.md`：桌面版集中测试清单
