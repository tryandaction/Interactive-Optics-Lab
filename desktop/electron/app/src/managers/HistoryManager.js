...
export class MoveComponentsCommand extends Command {
    constructor(componentIds, startPositionsMap, finalPositionsMap, componentsRef) {
        ...
        const fallbackComponents = Array.isArray(componentsRef)
            ? componentsRef
            : (typeof globalThis !== 'undefined' ? globalThis.components : undefined);
        this.componentsRef = Array.isArray(fallbackComponents) ? fallbackComponents : [];
    }
