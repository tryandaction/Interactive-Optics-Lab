...
### 模拟模式
- **光线追踪:** 默认模式，交互式观察几何光线传播与部分物理效应
- **理想薄透镜成像:** 教学辅助模式，绘制理想薄透镜成像的主光路图
- **科研图示:** 用于整理科研光路草图；导出质量仍需人工审校（见第11节）
...
科研图示模式用于把模拟光路整理成更清晰的科研草图。当前版本提供符号、连接点、标注、布局和导出能力，但仍处于重构前状态；用于论文或报告前应人工检查符号规范、线宽、字体、留白和导出文件质量。

### 进入图示模式
- **方式一:** 点击顶部菜单栏右侧的模式切换器，选择"绘图"
- **方式二:** 通过"模拟"菜单 → "模式: 科研图示"
...
- **注意:** 当前导出链路仍需验证，论文投稿前建议在 Inkscape/Illustrator 等矢量工具中复核。
